(function () {
    ...
    const SPRITE_URL = 'https://raw.githubusercontent.com/Ravenalt/owop-bunnies/main/cat4.png'; // Your pink-background sprite
    ...
    function loadAndCleanSprite(url, callback) {
        ...
        img.onload = () => {
            ...
            for (let i = 0; i < data.length; i += 4) {
                ...
                // Rough match for pink background (tweak if needed)
                if (r > 240 && g < 150 && b > 180) {
